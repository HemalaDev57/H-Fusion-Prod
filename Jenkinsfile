            ...
            steps {
                script {
                    ...
                    def artifactOutput = registerBuildArtifactMetadata(
                        ...
                        version: "1.0.1",
                        type: "docker",
                        url: "docker.io/hemaladev57/h-e2e-prod:1.0.1",
                        digest: "1122336370647070393461636632373839389",
                        label: "prod"
                    )
            ...
            steps {
                script {
                    ...
                    def artifactOutput1 = registerBuildArtifactMetadata(
                        ...
                        version: "1.0.1",
                        type: "docker",
                        url: "docker.io/hemaladev57/h-e2e-prod-1:1.0.1",
                        digest: "1122336370647070393461636632373839388",
                        label: "prod"
                    )
